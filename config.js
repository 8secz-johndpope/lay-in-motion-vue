{
  mode: 'development',
  context: 'D:\\Projects\\Vue\\LayInMotion-vue\\lay-in-motion',
  ...
  output: {
    path: 'D:\\Projects\\Vue\\LayInMotion-vue\\lay-in-motion\\dist',
    filename: '[name].js',
    publicPath: '/',
    globalObject: 'this'
  },
  resolve: {
    alias: {
      '@': 'D:\\Projects\\Vue\\LayInMotion-vue\\lay-in-motion\\src',
    ...
    modules: [
      'node_modules',
      'D:\\Projects\\Vue\\LayInMotion-vue\\lay-in-motion\\node_modules',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: 'D:\\Projects\\Vue\\LayInMotion-vue\\lay-in-motion\\node_modules\\.cache\\vue-loader',
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '17965887',
              emitWarning: true,
              emitError: false,
              eslintPath: 'D:\\Projects\\Vue\\LayInMotion-vue\\lay-in-motion\\node_modules\\eslint\\lib\\api.js',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'D:\\Projects\\Vue\\LayInMotion-vue\\lay-in-motion\\public\\index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'D:\\Projects\\Vue\\LayInMotion-vue\\lay-in-motion\\public',
          to: 'D:\\Projects\\Vue\\LayInMotion-vue\\lay-in-motion\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]
